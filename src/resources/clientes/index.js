...
var Clientes = /** @class */ (function (_super) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request(resourceName, {
                                qtype: "cliente.".concat(key),
                                query: value,
                                oper: oper,
                                page: page.toString(),
                                sortname: "cliente.".concat(sortAttr),
                                sortorder: sortorder,
                            })];
                    case 1:
                        response = _a.sent();
     ...
     */
    Clientes.prototype.buscarClientesPorCpfCnpj = function (cpfCnpj) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response.registros[0] || null];
                }
            });
        });
    };
     ...
     */
    Clientes.prototype.buscarClientesPorId = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var query, cliente;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        cliente = _a.sent();
                        return [2 /*return*/, cliente.registros[0]];
                }
            });
        });
    };
     ...
     */
    Clientes.prototype.alterarSenhaHotsite = function (id, novaSenha) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.update(resourceName, id, { senha: novaSenha })];
            });
        });
    };
    return Clientes;
