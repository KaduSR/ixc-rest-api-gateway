...
exports.OntResource = void 0;
var base_1 = require("../base");
/**
 * Recurso para interagir com as informações da ONT (radpop_radio_cliente_fibra) da API IXC.
 */
var OntResource = /** @class */ (function (_super) {
    __extends(OntResource, _super);
    function OntResource() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.resourceName = "radpop_radio_cliente_fibra";
        return _this;
    }
    /**
     ...
     */
    OntResource.prototype.listarOntInfo = function (idLogin_1) {
        return __awaiter(this, arguments, void 0, function (idLogin, page, rp, sortname, sortorder) {
            var query, response;
            if (page === void 0) { page = '1'; }
            if (rp === void 0) { rp = '1000'; }
            if (sortname === void 0) { sortname = 'radpop_radio_cliente_fibra.id'; }
...
exports.OntResource = OntResource;
