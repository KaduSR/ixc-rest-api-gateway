...
var Logins = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        value = attr[key];
                        query = {
                            qtype: "radusuarios.".concat(key),
                            query: String(value),
                            oper: oper,
                            page: page.toString(),
                            sortname: "radusuarios.".concat(String(sortAttr)),
                            sortorder: sortorder,
                        };
     ...
     */
    Logins.prototype.limparMac = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.update(resourceName, id, { mac: '' })];
            });
        });
    };
    /**
     ...
     */
    Logins.prototype.desconectarSessao = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                // Esta é uma rota especial no IXC
                return [2 /*return*/, this.update(resourceName, id, { acao: 'desconectar' })];
            });
        });
    };
    /**
     ...
     */
    Logins.prototype.obterDiagnostico = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.request(resourceName, {
