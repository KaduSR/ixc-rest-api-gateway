...
exports.Financeiros = void 0;
var base_1 = require("../base");
var resourceName = "fn_areceber";
/**
...
var Financeiros = /** @class */ (function (_super) {
    __extends(Financeiros, _super);
    function Financeiros(config) {
        return _super.call(this, config) || this;
    }
    /**
     * Lista/Filtra registros financeiros.
     */
    Financeiros.prototype.listar = function (attr_1) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        value = attr[key];
                        query = {
                            qtype: "fn_areceber.".concat(key),
                            query: String(value),
                            oper: oper,
                            page: page.toString(),
                            sortname: "fn_areceber.".concat(String(sortAttr)),
                            sortorder: sortorder,
                        };
...
exports.Financeiros = Financeiros;
